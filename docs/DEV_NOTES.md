...
### Бонусные тренировки (multiple workouts per day) — спроектировано, не реализовано
...
### Форсированный Challenge с Branch Journey Screen — спроектировано, не реализовано
