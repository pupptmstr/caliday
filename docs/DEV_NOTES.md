...
├── data/
│   ├── models/
│   │   ├── enums.dart                 ← BranchId, SetType, ExerciseType, Rank
│   │   ├── enums.g.dart               ← сгенерировано
│   │   ├── exercise.dart              ← статическая модель (без Hive)
│   │   ├── exercise_result.dart
│   │   ├── exercise_result.g.dart     ← сгенерировано
│   │   ├── skill_progress.dart
│   │   ├── skill_progress.g.dart      ← сгенерировано
│   │   ├── user_profile.dart
│   │   ├── user_profile.g.dart        ← сгенерировано
│   │   ├── workout_log.dart
│   │   └── workout_log.g.dart         ← сгенерировано
│   └── static/
│       └── exercise_catalog.dart      ← Push (7) + Core (6) + разминки/заминки
├── domain/                            ← пусто, следующий этап
└── features/                          ← пусто, следующий этап
```
...
Временный placeholder с:
- Streak / SP / Rank чипами
- Карточками веток Push и Core
- Кнопкой «Тренировка дня»
